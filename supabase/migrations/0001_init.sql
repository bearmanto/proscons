...
-- Public read (drop-then-create so it's safe to re-run)
...
drop policy if exists "public_read_question_votes" on public.question_votes;
create policy "public_read_question_votes"
...
create policy "public_read_reasons"
...
drop policy if exists "public_read_reason_votes" on public.reason_votes;
create policy "public_read_reason_votes"
